...
{
    astuces[1] = tr("Pour la table de 1, le résultat sera toujours égal au nombre que multiplie 1.<br />Exemple :<br /><strong>1 x <span style=\"text-decoration: underline;\">7</span> = <span style=\"text-decoration: underline;\">7</span></strong>");
    astuces[2] = tr("Pour la table de 2, le résultat est toujours un nombre paire et les résultats vont de 2 en 2.<br />Exmple :<br /><strong>2 x 1 = <span style=\"text-decoration: underline;\">2</span><br />2 x 2 = <span style=\"text-decoration: underline;\">4</span></strong>");
